...
class Gest(IntEnum):
    ...
    PINCH_MAJOR=35
    PINCH_MINOR=36
    THREE_FINGER_SWIPE_LEFT = 37
    THREE_FINGER_SWIPE_RIGHT = 38
    FOUR_FINGER_SWIPE_UP = 39
    FOUR_FINGER_SWIPE_DOWN = 40
    SCREENSHOT= 41
    ...
    def get_gesture(self):
        ...
        # Check for swipe direction
            if swipe_direction == 'left':
                return Gest.THREE_FINGER_SWIPE_LEFT
            elif swipe_direction == 'right':
                return Gest.THREE_FINGER_SWIPE_RIGHT
        elif self.finger_count == 4:
        # Check for swipe direction
            if swipe_direction == 'up':
                return Gest.FOUR_FINGER_SWIPE_UP
            elif swipe_direction == 'down':
                return Gest.FOUR_FINGER_SWIPE_DOWN
...
class Controller:
    ...
    def handle_controls(gesture, hand_result):  
        ...
        if gesture == Gest.THREE_FINGER_SWIPE_LEFT:
        # Perform undo action
            if gesture == Gest.THREE_FINGER_SWIPE_RIGHT:
        # Perform redo action
                if gesture == Gest.FOUR_FINGER_SWIPE_UP:
        # Perform app switching logic
                    if gesture == Gest.FOUR_FINGER_SWIPE_DOWN:
